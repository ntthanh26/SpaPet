		...
		<div class="container">
			<div style="margin-top: 50px">
				...
				while ($row = mysqli_fetch_array($kt)) {
					...
					<span style="background-color:#f1f1f1;padding: 7px;font-size:14px;border-radius: 20px;padding-left: 14px;padding-right: 14px;"><a href="#" style="color: #365899;cursor: pointer;font-weight: bold;">Nguyen Tien Thanh</a><span style="padding-left: 5px;">Like</span></span>
