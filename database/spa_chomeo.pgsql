...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 08, 2019 lúc 05:43 AM
...
(3, 'Custorm', 'mrcutom98', '123456', NULL);
...
CREATE TABLE bill_product (
  id_bill_product int NOT NULL,
  id_product int DEFAULT NULL,
  amount_buy int NOT NULL,
...
(33, 'BLOG1', 'upload/blog/2.png', '2018-05-29 20:35:43', 1),
(34, 'BLOG2', 'upload/blog/2.png', '2018-05-29 20:35:49', 1),
...
CREATE TABLE news (
  ...
  content mediumtext,
  time_news timestamp(0) DEFAULT NULL,
  url_image varchar(255) DEFAULT NULL,
  status int NOT NULL,
...
CREATE TABLE product (
  ...
  id_admin int DEFAULT NULL,
  id_class_product int DEFAULT NULL
) ;
...
(1, 'Royal Canin', 45000, 100, 'Royal Canin indoor 27 10kg Dành cho mèo trưởng thành trên 12 tháng tuổi.rnrn', 'upload/product/2140_indoor27.png', 1, 1),
...
(3, 'ROYAL CANIN MINI JUNIOR', 160000, 100, 'Kích thướt chó: loại chó nhỏ con;rnTrọng lượng chó lúc trưởng thành: dưới 10kg;rnĐộ tuổi: dưới 10 tháng;rnKhối lượng: 800g/bịch;', 'upload/product/thumb_15017346684195_royal-canin-mini-junior-dog-food_thucanchomeo.com.vn.jpg', 1, 1),
...
(8, 'Áo Khủng Long Cho Chó Mèo', 80000, 100, 'Có đủ size cho thú cưng đến 45kgrnrnSize 1: 80krnrnmối size tăng 10k', 'upload/product/ao-khung-long-xanh-cho-cho-meo.jpg', 1, 3),
...
(14, 'Nhà Nhựa Lớn Cho Chó Mèo 78*70*78', 1555000, 20, 'Nhà nhựa cao cấp cho chó mèo, kiểu dáng và màu sắc đẹp, hấp dẫn thú cưng nhà bạn, chất liệu bền, chắc chắnrnrnTháo rời, lắp ráp được.', 'upload/product/Thumbnail.jpg', 1, 2),
(15, 'Nhà Quả Dưa Hấu Nhỏ Cho Chó Mèo 32*41*26cm', 25000, 20, 'Ngôi nhà dưa hấu cho chó mèo được làm từ chất liệu cotton thông thoáng, dễ vệ sinh và phù hợp với khí hậu nóng ẩm ở Việt Nam.rn', 'upload/product/1118_nha_abc_hinh_qua_dua_hau_nho_xanh_32x41x26cm.jpg', 1, 2),
...
CREATE TABLE register_service (
  id_register_service int NOT NULL,
  id_users int DEFAULT NULL,
  id_service int DEFAULT NULL
) ;
...
(29, 'Dịch Vụ Cắt Tỉa L&ocirc;ng Ch&oacute; M&egrave;orn', 'Những ch&uacute; ch&oacute; hoặc m&egrave;o c&oacute; bộ l&ocirc;ng qu&aacute; d&agrave;y v&agrave; d&agrave;i thường l&agrave; điều kiện ph&aacute;t triển cực tốt của c&aacute;c loại k&yacute; sinh tr&ugrave;ng như rận, bọ ch&eacute;t, ve, v.v&hellip;.nếu bạn kh&ocirc;ng cắt tỉa l&ocirc;ng v&agrave; tắm gội thường xuy&ecirc;n cho ch&uacute;ng th&igrave; những con vật n&agrave;y c&oacute; thể l&acirc;y lan sang người bạn hoặc con c&aacute;i của bạn, g&acirc;y ra nhiều bệnh rất nguy hiểm.rnrnViệc cắt tỉa l&ocirc;ng cho ch&oacute; m&egrave;o đ&ograve;i hỏi phải c&oacute; nhiều thời gian v&agrave; kinh nghiệm th&igrave; mới c&oacute; thể l&agrave;m được. Thời gian để cắt tỉa l&ocirc;ng cho ch&oacute; m&egrave;o khoảng 80 ph&uacute;t &ndash; 180 ph&uacute;t. Việc cắt tỉa l&ocirc;ng đ&uacute;ng c&aacute;ch sẽ gi&uacute;p cho th&uacute; cưng của bạn trở n&ecirc;n gọn g&agrave;ng v&agrave; sạch sẽ hơn v&agrave; gi&uacute;p loại bỏ đi những phần l&ocirc;ng kh&ocirc;ng cần thiết, tế b&agrave;o chết.rnrnBạn kh&ocirc;ng biết l&agrave;m thế n&agrave;o để th&uacute; nu&ocirc;i của bạn trở n&ecirc;n đẳng cấp hơn c&aacute; t&iacute;nh hơn. Ch&uacute;ng t&ocirc;i sẽ gi&uacute;p bạn l&agrave;m điều đ&oacute;. Với dịch vụ cắt tỉa l&ocirc;ng ch&oacute; m&egrave;o ch&uacute;ng t&ocirc;i gi&uacute;p vật cưng của bạn trở n&ecirc;n ho&agrave;n hảo nhất.rn', NULL, 3, 'Ch&oacute; m&egrave;o l&agrave; những động vật cực kỳ hiếu động, ch&uacute;ng thường xuy&ecirc;n chạy nhảy ở ngo&agrave;i trời n&ecirc;n bộ l&ocirc;ng của ch&uacute;ng sẽ bị b&aacute;m rất nhiều bụi bẩn, việc cắt tỉa l&ocirc;ng cho ch&uacute;ng l&agrave; '),
(30, 'Dịch Vụ Giữ Th&uacute; Cưng &ndash; Nhận Giữ Vật Nu&ocirc;irn', 'Ch&oacute; m&egrave;o l&agrave; một trong những con vật nu&ocirc;i cực kỳ gần gũi với con người, ch&oacute; m&egrave;o l&agrave; một người bạn cực kỳ xinh xắn v&agrave; trung th&agrave;nh. Ng&agrave;y nay ch&oacute; m&egrave;o được xem như l&agrave; một th&agrave;nh vi&ecirc;n trong gia đ&igrave;nh, việc chăm s&oacute;c v&agrave; chơi đ&ugrave;a c&ugrave;ng ch&uacute;ng l&agrave;m con người cảm thấy thư giản v&agrave; thoải m&aacute;i hơn sau những giờ l&agrave;m việc.</br>rnrnBạn đang chuẩn bị một chuyến đi c&ocirc;ng t&aacute;c v&agrave;i ng&agrave;y? Hay cả gia đ&igrave;nh bạn chuẩn bị đi du lịch, bạn lo lắng kh&ocirc;ng c&oacute; ai chăm s&oacute;c cho th&uacute; cưng của bạn? Bạn rất muốn dẫn ch&uacute;ng đi theo những điều kiện ra x&ocirc;i kh&ocirc;ng cho ph&eacute;p bạn l&agrave;m điều đ&oacute;. H&atilde;y để dịch vụ giữ th&uacute; cưng của Bệnh Viện Ch&oacute; M&egrave;o Tphcm ch&uacute;ng t&ocirc;i gi&uacute;p bạn.rn', NULL, 3, 'Với <strong>Dịch Vụ Giữ Th&uacute; Cưng</strong> của ch&uacute;ng t&ocirc;i bạn sẽ y&ecirc;n t&acirc;m về th&uacute; cưng của m&igrave;nh mỗi khi đi xa, du lịch hay c&ocirc;ng t&aacute;c. C&aacute;c kh&aacute;ch sạn th&uacute; cưng của ch&uacute;ng t&ocir');
...
CREATE TABLE service_comment (
  ...
  id_service int DEFAULT NULL,
  comment text,
  tgian timestamp(0) DEFAULT NULL,
...
(5, 'Nguyễn Văn Triệu', 'nvtrieund@gmail.com', '0853543678', 1, 11, 'Hà Nội', '5kg - 10kg', 400),
(5, 'Nguyễn Minh Thông', 'thongminhaz@gmail.com', '0904613523', 2, 12, 'Hà Nội', '20kg - 30kg', 600),
...
(4, 'thanh1998', 'ntthanh', 'Nguyễn Tiến Thành', 'thanhnt2304@gmail.com', '964462603', 'Bắc Ninh', 1, NULL),
(5, '', '', '', '', '', '', 0, NULL);
...
ALTER TABLE image_introduction
  ADD CREATE INDEX id_image ON image_introduction (id_image);

--
-- Chỉ mục cho bảng `image_service`
--
ALTER TABLE image_service
  ADD CREATE INDEX id_service ON image_service (id_service);
...
--
ALTER TABLE admin
  MODIFY id_admin cast(11 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `bill_product`
--
ALTER TABLE bill_product
  MODIFY id_bill_product cast(11 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT cho bảng `blog`
--
ALTER TABLE blog
  MODIFY id_blog cast(11 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT cho bảng `blog_comment`
--
ALTER TABLE blog_comment
  MODIFY id_blog_comment cast(11 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `contact`
--
ALTER TABLE contact
  MODIFY id_contact cast(11 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE news
  MODIFY id_news cast(11 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `product`
--
ALTER TABLE product
  MODIFY id_product cast(11 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT cho bảng `register_service`
--
ALTER TABLE register_service
  MODIFY id_register_service cast(11 as int) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `service`
--
ALTER TABLE service
  MODIFY id_service cast(11 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE users
  MODIFY id_users cast(11 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
